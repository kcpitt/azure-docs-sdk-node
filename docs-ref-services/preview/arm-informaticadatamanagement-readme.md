...
---
# Azure InformaticaDataManagement client library for JavaScript - version 1.0.0-alpha.20240531.2 
...
[API reference documentation](/javascript/api/@azure/arm-informaticadatamanagement?view=azure-node-preview) |
